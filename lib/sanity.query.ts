/**
 * File: lib/sanity.query.ts
 * Function: Sanity Queries
 * Purpose: Defines GROQ queries used to retrieve specific datasets (profile, jobs, projects, posts) from Sanity.
 * Linked to:
 * - lib/sanity.client.ts (Queries are passed to sanityFetch)
 * - app/page.tsx (Imports specific queries like profileQuery)
 */
