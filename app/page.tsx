 ...
 * File: app/page.tsx
 * Function: Home Page
 * Purpose: The main landing page of the portfolio, fetching and displaying profile data, job history, and social links.
 * Linked to:
 * - lib/sanity.query.ts (Fetches profile data)
 * - lib/sanity.client.ts (Sanity client)
 * - app/components/pages/Job.tsx (Job history component)
 * - app/components/shared/Social.tsx (Social links component)
 * - app/components/pages/GithubCalendarComponent.tsx (Github contributions)
 */
      ...
      <section className="flex xl:flex-row flex-col xl:items-center items-start xl:justify-center justify-between gap-x-12 mb-16">
        <div key={profile?._id} className="lg:max-w-2xl max-w-2xl">
          <Slide>
            ...
            <p className="text-base dark:text-zinc-400 text-zinc-600 leading-relaxed font-incognito">
